...
def get_DDP_loader(test_batch, train_batch, root=base_dir, valid_size=0, valid_batch=0,
    ...
    DDP loader for CIFAR-10 dataset.
    Difference from DP loader: use DistributedSampler for train/valid/test datasets.
    '''

    # 현재 rank와 world size
    if not dist.is_initialized():
        raise RuntimeError("torch.distributed is not initialized. Please call dist.init_process_group first.")
    ...
    if valid_size > 0:
        ...
        # valid dataset은 test transform 적용
